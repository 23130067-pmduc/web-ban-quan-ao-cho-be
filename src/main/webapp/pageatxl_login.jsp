    ...
    <!-- ========== HEADER ========== -->
        <header class="header" id="header">
            ...
            <nav class="topbar">
                ...
                <p id="thongBao">Thông báo của tôi</p>
            </nav>
                ...
                <div class="actions">
                    ...
                    <div class="user-menu">
                        ...
                        <ul class="user-dropdown">
                            ...
                            <li><a href="trangchu.jsp"><i class="fa fa-sign-out" aria-hidden="true"></i> Đăng xuất</a></li>
                        </ul>
                    </div>
    ...
    <div class="product-container">
        ...
        <div class="product-info">
            ...
            <div class="product-actions">
                <a href="thanhtoan_login.jsp" class="link-cover"><button class="btn-buy-now">Mua ngay</button></a>
