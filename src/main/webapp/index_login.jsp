...
<body>
  ...
  <header class="header" id="header">
    ...
    <nav class="navbar">
        ...
        <div class="menu">
            <ul>
                <li><a href="index_login.html">Trang chủ</a></li>
  ...
  <section class="products">
    ...
    <div class="product-list">
      <div class="product-card">
        ...
        <a href="pageatxl_login.jsp" class="link-cover"></a>
  ...
  <section class="categories">
      ...
      <div class="category-block">
          ...
          <div class="load-more-container">
              <button id="load-more"><a href="listqabt_login.jsp">Xem thêm</a></button>
          </div>
      </div>
      ...
      <div class="category-block">
          ...
          <div class="load-more-container">
              <button id="load-more"><a href="listbegai_login.jsp">Xem thêm</a></button>
          </div>
      </div>
      ...
      <div class="category-block">
          ...
          <div class="load-more-container">
              <button id="load-more"><a href="phukien_login.jsp">Xem thêm</a></button>
          </div>
      </div>
  </section>
   ...
   <div class="footer">
    ...
    <section class="s-footer-2">
        ...
        <div class="footer-danhmuc">
            <h3>Danh mục</h3>
            <a href="index_login.html">Trang chủ</a>
