    ...
    <nav class="navbar">
        ...
        <div class="menu">
            <ul>
                ...
                <li ><a href="sanpham_login.html">Sản phẩm ▾</a>
                    <ul class="sub">
...
<section class="products">
    ...
    <div class="product-list">
        ...
        <div class="product-card">
            ...
            <h3><a href="pageatxl_login.jsp">Áo polo in hình khủng long</a></h3>
            <p><a href="pageatxl_login.jsp">Chất cotton 100%, thoáng mát</a></p>
            <span><a href="pageatxl_login.jsp">150.000₫</a></span>
        ...
        <div class="product-card">
            <img src="./img/aohoodie.jpg" alt="Áo Hoodie ngắn tay & Quần Short">
            <h3>Quần jean xanh</h3>
            <p>Sành điệu, thoải mái</p>
            <span>232.000₫</span>
            <button class="btn-add">Thêm vào giỏ</button>
        </div>
...
<div class="footer">
    ...
    <section class="s-footer-2">
        ...
        <div class="footer-danhmuc">
            ...
            <a href="sanpham_login.html">Sản Phẩm</a>
