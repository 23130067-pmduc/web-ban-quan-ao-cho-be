...
<section class="profile-container">
    ...
    <div class="profile-content">
        <div class="profile-top">
            ...
            <p>Yêu cầu vào: 10:04 16-11-2025</p>
        </div>


        <div class="top">
            <h2>Đã hủy đơn hàng</h2>
            <p>vào 10:04 16-11-2025</p>
        </div>
        ...
        <div class="center-bottom">
            <table class="info-table">
                <tr>
                    ...
                    <td class="value">Người mua</td>
                </tr>

                <tr>
                    <td colspan="3">Phương thức thanh toán</td>
                    <td class="value">Chưa thanh toán</td>
                </tr>

                <tr>
                    <td colspan="3">Mã đơn hàng</td>
                    <td>250728ASH2QPKF</td>
                </tr>
            </table>
        ...
        <div class="bottom">
            Lý do: Tôi không có nhu cầu mua nữa
        </div>
    </div>
