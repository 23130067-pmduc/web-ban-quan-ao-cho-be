...
<head>
    ...
    <style>
        *{
        ...
        /* Tin to ở hàng dưới cùng chiếm 2 cột */
        .newsItem.big {
...
<main class="container">
    ...
    <div class="newsContainer">
        <div class="newsItem">
            <a href="tintuc_1.jsp">
                <img src="http://127.0.0.1:5500/img/quanaokonen.webp" alt="Quần áo không nên cho trẻ em">
            </a>
            <h3><a href="tintuc_1.html">Những loại quần áo không nên mua cho trẻ em</a> </h3>
