...
<head>
    ...
    <style>
        *{
        ...
        .product-info {
            flex-grow: 1; /* chiếm phần còn lại cho text + giá */
            display: flex;
            flex-direction: column;
            gap: 14px;
        }
...
<section class="products">
    ...
    <div class="filter-bar">
        ...
        <div class="filter-category">
            <button class="filter-btn" data-filter="dobo">Đồ bộ</button>
            <button class="filter-btn" data-filter="vest">Vest</button>
            <button class="filter-btn" data-filter="aoaokhoac">Áo, áo khoác</button>
            <button class="filter-btn" data-filter="quan">Quần</button>
        </div>
        ...
        filterButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                products.forEach(product => {
                    const categories = product.getAttribute('date-category').split(' ');
